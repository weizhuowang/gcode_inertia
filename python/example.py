...
def main():
    ...
    segments = parse_segments(gcode, filament_diameter=1.75, filament_density=1.24)
    ...
    print(
        f"Ixx={inertia_origin[0, 0]:.3f}, Iyy={inertia_origin[1, 1]:.3f}, Izz={inertia_origin[2, 2]:.3f}"
    )
    ...
    print(
        f"Ixx={inertia_com[0, 0]:.3f}, Iyy={inertia_com[1, 1]:.3f}, Izz={inertia_com[2, 2]:.3f}"
    )
